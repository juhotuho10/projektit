...
fn main() {
    ...
    let fn_names: Vec<&str> = vec!["default_rust_sort", "comb_sort", "quick_sort","bucket_sort", "merge_sort_deque","merge_sort", 
                                    "insertion_sort", "shell_sort", "selection_sort", "optimized_bubble_sort", "bubble_sort"];

    let functions: Vec<fn(Vec<i32>) -> Vec<i32>> = vec![default_rust_sort, comb_sort, quick_sort, bucket_sort, merge_sort_deque, 
                                    merge_sort, insertion_sort, shell_sort, selection_sort, optimized_bubble_sort, bubble_sort];

    // sizes for vectors that we sort using the functions                                
    let range_vec = [8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768];
